...
HD_PWD='/home/it/Vivado_Projects/Lab2_Task5/Lab2_Task5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log full_4_adder_sub.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source full_4_adder_sub.tcl
