...
HD_PWD='/home/it/Vivado_Projects/Lab2_Task5/Lab2_Task5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log full_4_adder_sub.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source full_4_adder_sub.tcl -notrace
