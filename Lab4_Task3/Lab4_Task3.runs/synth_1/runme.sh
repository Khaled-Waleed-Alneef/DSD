...
HD_PWD='/home/it/Vivado_Projects/Lab4_Task3/Lab4_Task3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log regs_4_bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source regs_4_bit.tcl
