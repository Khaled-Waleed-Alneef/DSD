...
HD_PWD='/home/it/Vivado_Projects/Lab4_Task3/Lab4_Task3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log regs_4_bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source regs_4_bit.tcl -notrace
