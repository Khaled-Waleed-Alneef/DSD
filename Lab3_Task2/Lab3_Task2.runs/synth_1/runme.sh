...
HD_PWD='/home/it/Vivado_Projects/Lab3_Task2/Lab3_Task2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_sev_seg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ALU_sev_seg.tcl
