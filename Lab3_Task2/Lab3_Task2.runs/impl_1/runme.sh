...
HD_PWD='/home/it/Vivado_Projects/Lab3_Task2/Lab3_Task2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_sev_seg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ALU_sev_seg.tcl -notrace
