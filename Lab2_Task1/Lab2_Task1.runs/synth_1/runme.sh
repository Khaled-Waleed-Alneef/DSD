...
HD_PWD='/home/it/Vivado_Projects/Lab2_Task1/Lab2_Task1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log and4gate.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source and4gate.tcl
