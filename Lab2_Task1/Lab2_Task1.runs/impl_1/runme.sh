...
HD_PWD='/home/it/Vivado_Projects/Lab2_Task1/Lab2_Task1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log and4gate.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source and4gate.tcl -notrace
