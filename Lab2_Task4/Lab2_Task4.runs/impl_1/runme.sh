...
HD_PWD='/home/it/Vivado_Projects/Lab2_Task4/Lab2_Task4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log full_4_adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source full_4_adder.tcl -notrace
