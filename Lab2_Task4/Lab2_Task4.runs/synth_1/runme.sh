...
HD_PWD='/home/it/Vivado_Projects/Lab2_Task4/Lab2_Task4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log full_4_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source full_4_adder.tcl
